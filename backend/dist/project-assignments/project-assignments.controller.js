...
const update_project_assignment_dto_1 = require("./dto/update-project-assignment.dto");
const current_user_decorator_1 = require("../common/decorators/current-user.decorator");
let ProjectAssignmentsController = class ProjectAssignmentsController {
    constructor(service) {
        this.service = service;
    }
    findAll(user, projectId, workerId) {
        if (workerId)
            return this.service.findByWorker(user, workerId);
        if (projectId)
            return this.service.findByProject(user, projectId);
        throw new common_1.BadRequestException('Provide projectId or workerId');
    }
    create(user, dto) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List project assignments by projectId or workerId' }),
...
], ProjectAssignmentsController.prototype, "findAll", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_project_assignment_dto_1.CreateProjectAssignmentDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, update_project_assignment_dto_1.UpdateProjectAssignmentDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ProjectAssignmentsController.prototype, "remove", null);
exports.ProjectAssignmentsController = ProjectAssignmentsController = __decorate([
    (0, swagger_1.ApiTags)('project-assignments'),
    (0, swagger_1.ApiBearerAuth)('supabase-jwt'),
    (0, common_1.Controller)('project-assignments'),
