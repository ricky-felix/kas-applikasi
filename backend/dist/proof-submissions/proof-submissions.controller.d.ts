import { ProofSubmissionsService } from './proof-submissions.service';
...
export declare class ProofSubmissionsController {
    private readonly service;
    constructor(service: ProofSubmissionsService);
