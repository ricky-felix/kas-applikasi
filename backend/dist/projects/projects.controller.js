...
let ProjectsController = class ProjectsController {
    ...
    create(user, dto, orgId) {
        return this.projectsService.create(user, dto, orgId ?? '');
    }
    update(user, id, dto) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all projects scoped to the authenticated user' }),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_project_dto_1.CreateProjectDto, String]),
    __metadata("design:returntype", void 0)
