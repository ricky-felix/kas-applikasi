import { WorkerRegistrationsService } from './worker-registrations.service';
...
export declare class WorkerRegistrationsController {
    private readonly service;
    constructor(service: WorkerRegistrationsService);
