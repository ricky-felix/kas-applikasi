			...
			<TopBar
				crumb={
					<>
						...
						<span style={{ color: "var(--kas-ink-3)", margin: "0 8px" }}>
							/
						</span>
			...
			>
				<div>
					<div className="flex items-center gap-2.5 mb-2.5">
						...
						<MonoLabel size={10}>{p.category.toUpperCase()}</MonoLabel>
					</div>
					<h1
						style={{
					...
					>
						{[
							{ l: "Klien", v: p.client.name },
							{ l: "Mulai", v: p.start },
							{ l: "Est. Selesai", v: p.endEst },
							{ l: "Lokasi", v: p.address },
						].map((f, i) => (
							<div key={i}>
								<div
									style={{
				...
				<div className="grid" style={{ gridTemplateRows: "1fr 1fr" }}>
					...
					>
						{[
							{
								l: "Nilai Kontrak",
								v: fmtIDRshort(p.contractValue),
								accent: false,
							},
							{
								l: "Sisa Tagihan",
								v: sisa > 0 ? fmtIDRshort(sisa) : "Lunas",
								accent: sisa > 0,
							},
						].map((s, i) => (
							<div key={i}>
