    ...
    <div style={{ fontFamily: "var(--font-manrope), sans-serif", color: "var(--kas-ink)" }}>
      ...
      <div className="px-9 pt-7 pb-6" style={{ borderBottom: "1px solid var(--kas-line)" }}>
        <div className="flex justify-between items-center mb-6">
          <div style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, letterSpacing: "0.22em", color: "var(--kas-ink-3)", textTransform: "uppercase" }}>Analitik</div>
        ...
        <div className="flex items-center gap-3">
          ...
          {[
            { label: "PostHog · karyaagungsejati.com", color: "var(--kas-cobalt)" },
