...
import AMRequests, { RequestsSubTabs, ReqSubTab } from "@/components/admin/requests";
import AMFinancial, { FinancialSubTabs, SubTab as FinSubTab } from "@/components/admin/financial";
import AMMore from "@/components/admin/more/index";
